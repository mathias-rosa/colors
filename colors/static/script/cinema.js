...
const movieBox = document.getElementsByClassName("movie_box")[0];
    ...
    for (let movie of listMovie) {
        ...
        txtMovieGenre.textContent = movie.genre;
